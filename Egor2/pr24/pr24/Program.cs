...
namespace pr24
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                //1Вставить первую строку после строк, в которых находится максимальный элемент. 
        ...
        {
            //Удалите столбцы, в которых есть заданный элемент. Если такого столбца нет, то вывести сообщение об этом.
