...
namespace pr24
{
    class Program
    {
        ...
        {
            //1Вставить столбец двоек перед столбцами, в которых встретился максимальный элемент.
        ...
        {
            //Удалите строки, содержащие пятёрки. Если такой строки нет, то вывести сообщение об этом
